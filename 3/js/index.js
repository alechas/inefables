// I started trying to make the player work but ran out of time, may pick it up again later, uncomment below to get it to work :D ~csilk

//--------------------------------------------------


// Below is lovingly forked from BBPlayer - https://github.com/73rhodes/bbplayer
...
(function () {
  ...
  BBPlayer.prototype.updateDisplay = function () {
    ...
    this.bbplayer.getElementsByClassName('length').item(0).innerHTML = duration;
    this.bbplayer.getElementsByClassName('elapsed').item(0).innerHTML = elapsed;
    this.bbplayer.getElementsByClassName('title').item(0).innerHTML = title;
    var playButton = this.bbplayer.getElementsByClassName("play").item(0);
  ...
  BBPlayer.prototype.setClickHandlers = function () {
    ...
    [].forEach.call(
      self.bbplayer.getElementsByClassName('forward'),
      function (el) {
        el.addEventListener('click', function () {
          self.log('event: click .forward');
          self.loadNext();          
        });
      }
    );
    ...
    // Toggle play / pause
    [].forEach.call(
      self.bbplayer.getElementsByClassName('play'),
      function (el) {
        el.addEventListener('click', function () {
          self.log('event: click .play');
    ...
    // Activate rewind
    [].forEach.call(
      self.bbplayer.getElementsByClassName('rewind'),
      function (el) {
        el.addEventListener('click', function () {
          self.log('event: click .rewind');
