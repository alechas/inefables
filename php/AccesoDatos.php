...
class AccesoDatos
{
    ...
    private function __construct()
    {
        try { 
            ...
            // Local
            $this->objetoPDO = new PDO('mysql:host=localhost;dbname=inefables;charset=utf8', 'root', '', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
